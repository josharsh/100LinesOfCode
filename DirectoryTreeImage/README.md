...
* A single file utility that visualizes your directory structure.
...
Here is a usage example for the Enter case (the current folder the program is executed in). The output in the console will look something like the following:
