...
Feel free to add more amazing quotes to the motivation.txt file. Just keep the text file in the same directory as the motivation.sh file and update the number on the 2nd line to reflect the number of quotes.
