...
measures her body weight and abdominal circumference every week. I got an idea
...
To run the app, just type `node very-simple-logger`, then open [http://127.0.0.1:3000](http://127.0.0.1:3000) on your browser.
